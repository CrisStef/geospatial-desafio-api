...
import com.geospatial.desafio.domain.exception.EntityNotFoundException;
import com.geospatial.desafio.domain.exception.ValidatorException;
...
public class ApiExceptionRandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handleEntityAlreadyExists(EntityAlreadyExistsException e, WebRequest request) {
		HttpStatus status = HttpStatus.CONFLICT;
		String detail = e.getMessage();

		Problem problem = createProblemBuilder(status, ProblemType.ENTITY_ALREADY_EXISTS, detail).message(detail).build();
	...
	public ResponseEntity<Object> handleInvalidEnum(IllegalArgumentException ex, WebRequest request) {
		HttpStatus status = HttpStatus.BAD_REQUEST;
